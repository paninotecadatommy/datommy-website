            ...
            <div className="pt-4 border-t border-border">
              ...
              <div className="flex gap-4 flex-wrap">
                {["Deliveroo", "Just Eat", "Glovo"].map((platform) => (
                  <a key={platform} href="#" className="bg-card border border-border rounded-lg px-5 py-3 font-accent uppercase tracking-wider text-sm hover:border-primary transition-colors">
                    {platform}
                  </a>
                ))}
              </div>
