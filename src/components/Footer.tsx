      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                href="https://it-it.facebook.com/datommy"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-card border border-border rounded-lg px-4 py-2 text-sm hover:border-primary transition-colors"
              >
                Facebook
              </a>
              <a
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary font-accent uppercase tracking-wider text-sm hover:underline"
          >
